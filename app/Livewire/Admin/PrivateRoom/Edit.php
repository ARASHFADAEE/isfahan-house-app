...
class Edit extends Component
{
    ...
    public function mount(PrivateRoom $privateRoom): void
    {
        $this->privateRoom = $privateRoom;
        $this->branch_id = $privateRoom->branch_id;
        $this->room_number = $privateRoom->room_number;
        $this->status = $privateRoom->status;
        $this->subscription_id = $privateRoom->subscription_id;
        $this->user_id = $privateRoom->user_id;
    ...
    protected function rules(): array
    {
        return [
            ...
            'room_number' => [
                ...
                Rule::unique('private_rooms', 'room_number')
                    ->where(fn($q) => $q->where('branch_id', $this->branch_id))
                    ->ignore($this->privateRoom->id)
            ],
    ...
    public function update(): void
    {
        ...
        session()->flash('success', 'اتاق اختصاصی با موفقیت بروزرسانی شد.');
    ...
    {
        return view('livewire.admin.private_room.edit');
    }
}