...
$(document).on("click",".layout-option > li", function () {
  ...
  if(layoutClassName.includes('selected')) {
    return;
  }
  ...
  if(layoutClassName === "box-layout") {
    $("body")
      .removeClass("ltr")
      .addClass('rtl box-layout');
    $("html").attr("dir", "rtl");
  } else {
    $("body")
      .removeClass("rtl ltr box-layout")
...
function loadConfiguration(){
  ...
  const defaultLayoutOption = $("html").attr("dir");
  let layoutOption = getLocalStorageItem("layout-option", defaultLayoutOption || "rtl");
